      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center text-white">
          ...
          <p className="text-xl text-emerald-100 mb-12 max-w-3xl mx-auto">
            Join thousands of successful investors who have already started
            building their financial future with Fidelity Assets.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              to="/register" 
              className="bg-white text-emerald-600 px-8 py-4 rounded-lg text-lg font-semibold hover:bg-emerald-50 transform hover:scale-105 transition-all duration-300 flex items-center justify-center space-x-2"
            >
